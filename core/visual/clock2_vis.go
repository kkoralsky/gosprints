...
func (c *clock2Vis) drawDashboard(playerNum uint32) {
	var (
...
func (c *clock2Vis) clearDashboard(playerNum uint32) {
	var (
		winWidth    = c.win.Bounds().W()
		spriteWidth = c.clockSprite.Picture().Bounds().W()
...
func (c *clock2Vis) updateRace(playerNum, dist uint32) {
	var (
